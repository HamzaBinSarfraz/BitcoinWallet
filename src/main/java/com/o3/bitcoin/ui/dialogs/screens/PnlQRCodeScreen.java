...
public class PnlQRCodeScreen extends javax.swing.JPanel {
    ...
    public void loadQRCode() {
        try {
            ...
            QRCodeUtil.createQRCode("bitcoin:" + address + "?" + "amount=" + btcAmount + "&" + "label=lable&" + "message=" + description, qrcodeFilePath, charset, hintMap, 200, 200);
            System.out.println("bitcoin:"+address + "?" + "amount=" + btcAmount + "&" + "label=lable&" + "message=" + description);
