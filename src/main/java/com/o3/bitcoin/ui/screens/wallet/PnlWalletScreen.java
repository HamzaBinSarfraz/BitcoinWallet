...
public class PnlWalletScreen extends javax.swing.JPanel implements ActionListener, BasicScreen {
    ...
    public static HDAccount currentAccount = null;
    ...
    private void initComponents() {
        ...
        pnlNewPayment.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        pnlNewPayment.add(btnNewPayment, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 6, 130, 30));

        lblQrcode.setBackground(Colors.NAV_MENU_WALLET_COLOR);
        ...
        lblQrcode.setText("+ Request Payment");
        ...
        pnlNewPayment.add(lblQrcode, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 6, 150, 30));
        ...
        pnlTop.add(pnlWalletSummary, java.awt.BorderLayout.EAST);
    ...
    public void showWalletControls() {
        ...
        currentService.setWalletEventListener(new AbstractWalletEventListener() {
            ...
            public void onWalletChanged(Wallet wallet) {
                ...
                try {
                    nextAddress = currentAccount.nextChangeAddress().toString();
        ...
        if (transactions != null && !transactions.isEmpty()) {
            ...
            for (Transaction transaction : transactions) {
                ...
                if (sameWalletTrans) {
                    ...
                    for (TransactionOutput txo : lto) {
                        toAccount = currentService.getAddressAcountName(txo.getAddressFromP2PKHScript(currentService.getWallet().getParams()));
                        System.out.println("account name of the address ..." + toAccount + "\n" + "______________");
                ...
                System.out.println(count++ + ":::" + "Date from wallet screen..." + Utils.formatTransactionDate(transaction.getUpdateTime()));
                if (!sameWalletTrans) {
    ...
    public static javax.swing.JComboBox cmbWallets;
